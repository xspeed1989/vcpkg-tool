...
namespace vcpkg
{
    ...
    {
        static const StringLiteral CRT_LINKAGE = "CRTLinkage";
        static const StringLiteral CRT_LINKAGE_DEBUG = "CRTLinkageDebug";
        static const StringLiteral LIBRARY_LINKAGE = "LibraryLinkage";
    }
